<template>
  ...
  <span v-else><small class="has-text-primary">Following</small> <b-dropdown style="width:30px;" position="is-bottom-left" hoverable aria-role="list">
            <b-icon
                icon="chevron-down"
                slot="trigger" size="is-small">
            </b-icon>
