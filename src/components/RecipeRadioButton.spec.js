...
import RecipeRadioButton from '../components/RecipeRadioButton'

let wrapper

describe('RecipeRadioButton', () => {
    beforeEach(() => {
        wrapper = shallowMount(RecipeRadioButton)
    })

    it('is called', () => {
        expect(wrapper.name()).toBe('RecipeRadioButton')
